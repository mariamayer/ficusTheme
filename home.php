...
<div class="intro">
		...
		<div class="nosotros text-left">
			...
			<p><?php echo __('[:en]'.$nosotros_en.'[:es]'.$nosotros_es); ?></p>
		</div>
		...
		<div class="container centrado">
			...
			<div class="col-md-12 scrollme">
				...
				<span class="mantenimiento">
					...
					<br>
					<hr class="separacion">
					<?php echo __('[:en]Maintenance <span class="extra"> OPTIONAL </span>[:es]Mantenimiento <span class="extra"> OPCIONALES </span>'); ?>
				</span>
				</div>
			</div>
		</div>
